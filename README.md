...
```javascript
import unary5dBy from 'https://cdn.jsdelivr.net/gh/stdlib-js/array-base-unary5d-by@v0.1.1-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/array-base-unary5d-by/actions/workflows/test.yml/badge.svg?branch=v0.1.1
[test-url]: https://github.com/stdlib-js/array-base-unary5d-by/actions/workflows/test.yml?query=branch:v0.1.1
